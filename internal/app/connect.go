...
func Connect(w http.ResponseWriter, r *http.Request) {
	...
	http.SetCookie(w, &http.Cookie{Name: "access_token", Value: accessToken, HttpOnly: true, Secure: true, SameSite: http.SameSiteStrictMode, MaxAge: int(expiresIn)})
	http.SetCookie(w, &http.Cookie{Name: "platform_user_id", Value: strconv.Itoa(int(userId)), HttpOnly: true, Secure: true, SameSite: http.SameSiteStrictMode, MaxAge: int(expiresIn)})
